...
<div className="div" style={{border:'1px solid red',flex:1}}>我是一个div</div>
<div className="div" style={{border:'1px solid red',flex:1}}>我是一个很多字div</div>
<div className="div" style={{border:'1px solid red',flex:1}}>我是一个更多字而且第三个div</div>
</div>
}
